...
export const timelineEvents: TimelineEventModel[] = [
    ...
    new TimelineEventModel({
        ...
        endDate: new Date(),
        name: 'Lockpath',
        description: 'Fresh out of college, I took a job as a Sofware Engineer with Lockpath in Overland Park, Kansas. ' +
    ...
    new TimelineEventModel({
        ...
        description: 'After more than a year of Covid-19 delaying most companies\' (including NAVEX) return to office plans, I decided to transition my role with NAVEX to full-time remote. ' +
